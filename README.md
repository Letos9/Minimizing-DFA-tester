...
> `PassthroughMinimizer` реализует минимизацию PT-DFA по алгоритму уточнения разбиения из статьи Valmari-Lehtinen. Имя класса сохранено как точка подключения к `DFAMinimizer`.
